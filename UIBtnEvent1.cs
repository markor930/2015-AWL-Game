...
public class UIBtnEvent1 : MonoBehaviour, 
...
IPointerClickHandler {
	...
	void Start () {
		...
		gameObject.GetComponent<RectTransform> ().position = new Vector3 (Screen.width / 2 - 125, Screen.height / 2 + 165, 0);
	}
	
	// Update is called once per frame
	void Update () {
		UIText.GetComponent<Text>().text = Game_MainScript.btn_1;
	}
	...
	public void OnPointerClick(PointerEventData eventData)
	{
		...
		{
			Game_MainScript.BtnOneClick = true;
		}
	}
	...
	{
		SoundAnswer.Btn01 = false;
		Game_MainScript.TestSound.GetComponent<SoundAnswer> ().enabled = false;

		if(SoundAnswer.Btn02 == false && SoundAnswer.Btn03 == false)
		{
			InBtnTime = 0.0f;
		}
	}
