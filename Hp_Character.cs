...
public class Hp_Character : MonoBehaviour {
	...
	void CHP_Follow()
	{
		...
		Vector3 HP_Position = MainCamera.WorldToViewportPoint(Game_MainScript.Character.transform.position);
